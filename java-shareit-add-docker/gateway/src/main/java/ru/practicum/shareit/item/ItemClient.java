...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getItemByItemIdAndUserId(long userId, long from, long size) {
    ...
    public ResponseEntity<Object> delItem(long itemId) {
        return delete("/" + itemId);
    }

    public ResponseEntity<Object> search(String text, long from, long size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
