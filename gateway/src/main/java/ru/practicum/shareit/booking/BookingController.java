...
public class BookingController {
    ...
    @PatchMapping("/{id}")
    ResponseEntity<Object> setApprove(@PathVariable Long id, @RequestHeader("X-Sharer-User-Id") Long bookerId,
                                      @RequestParam Boolean approved) {

        log.info("Get booking {}, userId={}", id, bookerId);
        return bookingClient.update(id, bookerId, approved);
    }
