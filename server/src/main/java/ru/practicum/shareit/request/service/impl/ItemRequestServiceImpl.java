...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    public List<ItemRequestDto> getAll(Long userId, Integer from, Integer size) {
        ...
        Page<ItemRequest> requests = itemRequestRepository.findAllByRequesterIdNot(userId, pageable);
    ...
    public List<ItemRequestDto> getAllForRequester(Long requesterId) {
        getUser(requesterId);
        List<ItemRequest> requests = itemRequestRepository.findAllByUserId(requesterId);
