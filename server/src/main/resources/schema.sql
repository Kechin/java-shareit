...
(
    ...
    CONSTRAINT booking_items FOREIGN KEY (item_id) REFERENCES items (id) ON DELETE CASCADE,
    CONSTRAINT owner FOREIGN KEY (booker_id) REFERENCES users (id)   ON DELETE CASCADE
